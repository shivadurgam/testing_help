...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { ans1: @paper.ans1, ans2: @paper.ans2, ans3: @paper.ans3, ans4: @paper.ans4, q1: @paper.q1 }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { ans1: @paper.ans1, ans2: @paper.ans2, ans3: @paper.ans3, ans4: @paper.ans4, q1: @paper.q1 }
    assert_redirected_to paper_path(assigns(:paper))
  end
